...
import (
	...
	"github.com/home-sol/multicast-proxy/pkg/net/mdns"
	"github.com/spf13/cobra"
)

var cmdReflector = &cobra.Command{
	Use:   "reflector",
	Short: "MDNS Reflector",
	Long:  "MDNS Reflector",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return mdns.Reflector(cfg.NetInterface, poolsMap, deviceToVlanTags)
	},
}
